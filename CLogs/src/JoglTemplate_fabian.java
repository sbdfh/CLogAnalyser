...
public class JoglTemplate_fabian extends Frame implements GLEventListener,
		MouseListener, MouseMotionListener, MouseWheelListener, KeyListener
{
	...
	private float view_transx = 0.0f, view_transy = 0.0f;

	protected float view_transz = -10.0f;
